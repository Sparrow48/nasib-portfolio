...
function AboutMe() {
  return (
    <section id="about" className="pb-12 border-b">
      <div className="flex flex-col items-center content-center px-6 py-24 mx-auto space-y-10 md:max-w-6xl">
        ...
        <div className="text-lg italic font-bold tracking-wide md:max-w-3xl">
          <p>
            ...
            team and individually. I am always eager to learn from anyone and
        ...
        <div className="flex flex-col items-center space-y-5">
          ...
          <div>
            <ul className="flex flex-wrap space-y-5 text-lg md:max-w-sm">
              ...
              <li className="flex px-2 m-1 bg-gray-200 rounded-lg">
                JavaScript
              </li>
